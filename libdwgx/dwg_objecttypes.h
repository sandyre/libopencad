...
{
        DWG_OBJECT_POLYLINE2D, DWG_OBJECT_POLYLINE3D,
        DWG_OBJECT_POLYLINE_MESH, DWG_OBJECT_POLYLINE_PFACE, DWG_OBJECT_POINT,
        DWG_OBJECT_ELLIPSE, DWG_OBJECT_ARC, DWG_OBJECT_CIRCLE, DWG_OBJECT_LINE,
        DWG_OBJECT_LWPOLYLINE, DWG_OBJECT_RAY
};
